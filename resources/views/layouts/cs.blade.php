            ...
            <div class="w-1/2 pr-0">
                <div class="flex relative inline-block float-right">
                    ...
                    <div class="relative text-sm">
                        <a href="{{ route('cs.logout') }}" class="px-4 py-2 block text-blue-500 hover:text-blue-700 no-underline hover:no-underline">Logout</a>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    <li class="mr-6 my-2 md:my-0">
                        <a
                            href="{{ route('cs.index') }}"
                            class="block py-1 md:py-3 pl-1 align-middle no-underline hover:text-gray-900 border-b-2 {{ request()->is('cs') ? 'border-orange-600 text-orange-600' : 'border-white text-gray-500' }} hover:border-orange-600"
                        >
